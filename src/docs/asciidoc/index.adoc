...
include::{snippets}/change-password/request-body.adoc[]
...
== 댓글 수 조회
=== 요청
include::{snippets}/comments-count/http-request.adoc[]
include::{snippets}/comments-count/path-parameters.adoc[]

=== 응답
include::{snippets}/comments-count/http-response.adoc[]
include::{snippets}/comments-count/response-fields.adoc[]
